...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "django_ecommerce/static_cdn", "static_root")

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "django_ecommerce/static_cdn", "media_root")
